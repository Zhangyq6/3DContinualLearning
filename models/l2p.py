...
class Learner(BaseLearner):
    ...
    def after_task(self):
        ...
        print("The current prompt pool parameters is : \n", self._network.backbone.prompt.prompt)
    ...
    def _init_prompt(self, optimizer):
        ...
        if args.model.prompt_pool and args.model.shared_prompt_pool:
        ...
        if args.model.prompt_pool  and args.model.shared_prompt_key:
            prev_start = (task_id - 1) * args["top_k"]
            prev_end = task_id * args["top_k"]
    ...
    def _init_train(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                if self.args.model.pull_constraint and 'reduce_sim' in output:
                    pass
                    # loss = loss - self.args.model.pull_constraint_coeff * output['reduce_sim']
            ...
            #     )
            # else:
            info = "Task {}, Epoch {}/{} => Loss {:.3f}, Train_accy {:.2f}, Prompt_idx {}".format(
                self._cur_task,
                epoch + 1,
                self.args['tuned_epoch'],
                losses / len(train_loader),
                train_acc,
                output['prompt_idx'][0] if 'prompt_idx' in output else None
            )
